...
import kr.co.korogom.service.ReplyService;
import lombok.AllArgsConstructor;
import lombok.extern.log4j.Log4j;

@RestController
@Log4j
@RequestMapping("/reservation/replies")
@AllArgsConstructor
public class ReplyController {

	private ReplyService service;
	
	@PostMapping(value = "/register", consumes="application/json", produces = {MediaType.TEXT_EVENT_STREAM_VALUE})
...
//	public ResponseEntity<ReplyPageDTO> getList2(@PathVariable("page") int page, @PathVariable("bno") Long bno){
//		Criteria cri = new Criteria(page,10);
//		log.info("get Reply List bno : "+bno);
//		log.info("cri : "+cri);
//		return new ResponseEntity<>(service.getListPage(cri, bno),HttpStatus.OK);
