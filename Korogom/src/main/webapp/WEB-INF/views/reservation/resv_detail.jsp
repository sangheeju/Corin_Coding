...
<div class="row">
	<div class="col-lg-12">
		<h2>Reservation Board detail</h2>
	</div>
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="/resv_modify" method="post">
...
$(document).ready(function(){
	...
	$("#modifyBtn").on("click", function(){
		formObj.attr("action", "/reservation/resv_modify");
		formObj.attr("method", "get");		
		formObj.submit();
	});
	
	$("#removeBtn").on("click", function(){
		formObj.attr("action", "/reservation/resv_remove");
		formObj.submit();
	});
	
	$("#goListBtn ").on("click", function(){
		formObj.attr("method", "get");
		formObj.attr("action", "/reservation/resv_board");
		formObj.submit();
	});
});
</script>
