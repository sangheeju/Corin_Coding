	...
	<table class="table table-striped table-hover">
                  ...
                  <c:forEach items="${list}" var="board">
                  	<tr>
                  		...
                  		<td><a class='move' href='/community/petsitter_detail${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${board.bno}'><c:out value="${board.btitle }"/></a></td>
