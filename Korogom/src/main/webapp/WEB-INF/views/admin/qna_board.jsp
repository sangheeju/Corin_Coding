...
<div class="row">
	...
	<table class="table table-striped table-hover">
                  ...
                  <c:forEach items="${list}" var="board">
                  	<tr>
                  		...
                  		<td><a class='move' href='/admin/qna_detail${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${board.bno}'><c:out value="${board.btitle }"/></a></td>
	...
	<div>            
    	&nbsp;<a href='/admin/qna_register' onClick='fn_write()' class="btn btn-success pull-right">글쓰기</a><br>&nbsp;
    </div>
    <div class='box-body'>
    ...
    <div class='text-center'>
    	<ul class="bpaging">
    		<c:if test="${pageMaker.prev }">
    			<li class='pbutton'><a class='pnum' href="qna_board${pageMaker.makeSearch(pageMaker.startPage -1)}">&laquo;</a>
    			</li>
    		</c:if>
    		<c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage }">
    			<li class="pbutton">
    				<a class="pnum${pageMaker.cri.page == num ? '_active':''}" href="qna_board${pageMaker.makeSearch(num)}">${num}</a>
    			</li>
    		</c:forEach>
    		<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
    			<li class="pbutton" ><a class='pnum' href="qna_board${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
    		</c:if>
    	</ul>
    </div>
    </div>
