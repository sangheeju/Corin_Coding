	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="/qna_modify" method="post">
...
$(document).ready(function(){
	...
	$("#modifyBtn").on("click", function(){
		formObj.attr("action", "/admin/qna_modify");
		formObj.attr("method", "get");		
		formObj.submit();
	});
	
	$("#removeBtn").on("click", function(){
		formObj.attr("action", "/admin/qna_remove");
		formObj.submit();
	});
	
	$("#goListBtn ").on("click", function(){
		formObj.attr("method", "get");
		formObj.attr("action", "/admin/qna_board");
		formObj.submit();
	});
});
</script>
...
$(document).ready(function(){
	(function(){
		...
		$.getJSON("/admin/getAttachList",{bno: bno}, function(arr){
			console.log("file")
			console.log("bno : "+bno);
			var str = "";
