...
# 맨 윗줄
btn_f16 = Button(root, text="F16", width=5, height=2) #btn_f16 = Button(root, text="F16", padx=10, pady=10)
btn_f17 = Button(root, text="F17", width=5, height=2)
btn_f18 = Button(root, text="F18", width=5, height=2)
btn_f19 = Button(root, text="F19", width=5, height=2)

btn_f16.grid(row= 0, column=0, sticky=N+E+W+S, padx=3, pady=3) # 동서남북(NEWS)으로 늘려서 붙이기)
